...
[Note] : You need to change `MySQL connector` name and `Amazon Corretto` name in group variable files.
...
## Adding IP of the server in host_vars
1. Need to change the value of hostname in `apim_1.yml`
